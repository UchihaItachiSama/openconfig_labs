...
class MathServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subtract = channel.unary_unary(
                '/calculator.MathService/Subtract',
...
def add_MathServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'calculator.MathService', rpc_method_handlers)
...
class MathService(object):
    ...
    def Add(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calculator.MathService/Add',
    ...
    def Subtract(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calculator.MathService/Subtract',
